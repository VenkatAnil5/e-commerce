  ...
  <body>
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Venkat" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Anil" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Rajahmundry" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="533126" name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="venkatanil@gmail.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <p style="text-align:center; font-size:0.8em;">&copy; DBMS. All Rights Reserved.</p>
        </footer>
